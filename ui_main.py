...
class MainWindow(QMainWindow):
    ...
    def create_scheduler_section(self):
        ...
        self.create_startup_btn = QPushButton("⚙️ Create Startup Setting")
        self.create_startup_btn.setObjectName("createStartupBtn")
        self.create_startup_btn.setCursor(Qt.CursorShape.PointingHandCursor)
        self.create_startup_btn.setMinimumHeight(45)
        create_startup_font = QFont("Segoe UI", 11, QFont.Weight.Bold)
        self.create_startup_btn.setFont(create_startup_font)
        layout.addWidget(self.create_startup_btn)
    ...
    def create_refresh_section(self):
        ...
        # Stop All Operations button (general stop button)
        self.stop_all_btn = QPushButton("⏹️ Stop All Operations")
        ...
        stop_font = QFont("Segoe UI", 12, QFont.Weight.Bold)
        self.stop_all_btn.setFont(stop_font)
        self.stop_all_btn.setEnabled(False)  # Disabled by default (enabled when operations are running)
